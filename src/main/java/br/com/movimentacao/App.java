 ...
 * @version 1.0
 * 
 *          App : Classe que principal que gera o relatório e executa o método
 *          main com toda lógica e retorno de informações
 *
 */
public class App {
	...
	public static void main(String[] args) throws Exception {
		...
		Type listTypeP = new TypeToken<List<PagamentosBean>>() {
		}.getType();
		List<PagamentosBean> pagamentos, pagamentosTratados;
		PagamentosBean pagamento = new PagamentosBean();

		Type listTypeR = new TypeToken<List<RecebimentosBean>>() {
		}.getType();
		...
		float valor = 0;
		float totDivesao = 0, totViagem = 0, totTransporte = 0, totHospedagem = 0, totAlimentacao = 0, totVestuario = 0,
				totHigiene = 0;
		...
		for (PagamentosBean pagamentosBean : pagamentos) {
			...
			if (pagamentosBean.getCategoria().equalsIgnoreCase("viagem")) {
				...
				totHospedagem += valor;
			} else if (pagamentosBean.getCategoria().equalsIgnoreCase("alimentacao")
					|| pagamentosBean.getCategoria().equalsIgnoreCase("alimentação")) {
			...
			totalGasto = totViagem + totDivesao + totTransporte + totHospedagem + totAlimentacao + totVestuario
					+ totHigiene;
		}

		// cada categoria recebe seu total gasto
		float categoriasGasto[] = { totDivesao, totViagem, totTransporte, totHospedagem, totAlimentacao, totVestuario,
				totHigiene };
		String categorias[] = { "Diversão", "Viagem", "Transporte", "Hospedagem", "Alimentação", "Vestuário",
				"Higiene" };
		...
		do {
			...
			case 6:
				...
				System.out.println("");
				System.out.println(
						"CATEGORIA:" + categoriaMaior + " VALOR GASTO: R$" + formatador.format(categoriaMaiorGasto));
				System.out.println("");
				System.out.println("*************************************************************");
				break;
			case 7:
